    ...
    <div className="flex flex-col lg:flex-row h-screen">
      ...
      <div className="w-full lg:w-1/2 p-4 flex justify-center items-center">
        <div className="text-center space-y-3 w-full max-w-md">
          ...
          <h2 className="text-4xl font-bold">Login Account</h2>
              ...
              <fieldset className="fieldset space-y-2 text-left">
                ...
                <div>
                  ...
                  <div className="text-right mt-1">
                    <a className="text-sm link link-primary">Forgot password?</a>
                  </div>
                </div>
          ...
          <div className="mt-2">
            <p>Don't have an account? <Link to="/register"><span className="font-bold underline">Register Now</span></Link></p>
          </div>
        </div>
      </div>
    </div>
